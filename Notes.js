...
How to Use:
  ...
  in the app folder, the loading.js is a spinner that will apply to all pages in the app folder, no matter all nested it is(maybe not...). This is uses the process of Streaming. 
